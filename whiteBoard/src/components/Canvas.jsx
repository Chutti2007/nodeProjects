...
export default function Canvas(props) {
    ...
    return (
        <>
            <canvas ref={canvasRef} className={props.class} width={1510} height={1060} style={{ position: "relative", cursor: "none", border: "1px solid white", borderLeft: "0px solid" }} id="canvas_new" tabIndex="0"> </canvas>
