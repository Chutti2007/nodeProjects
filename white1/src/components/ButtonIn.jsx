...
export default function ButtonDiv(props) {
  ...
  return (
    <div className={style.parent} style={{ width: "100%", height: "10%", display: "flex", justifyContent: "center", alignItems: "center", gap: "2%", position: "relative", background: "#1f2937", flexDirection: "row"}}>
      <Button
