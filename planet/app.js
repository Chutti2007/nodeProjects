...
app.get("/planet", (req, res) => {
  ...
  if (planetInfo != null) {
    ...
    console.log("Something went wrong can't find the planet details");
...
app.listen("3200", (err) => {
  if (err) {
    ...
    console.log("Server connected successfully on 3200");
  }
})


function findPlanetDetails(name) {

  for (let obj of planetData) {
